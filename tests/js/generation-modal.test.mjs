 ...
 * real DOM and is covered by `generate-forms.cy.js`.
 *
 * Until this existed, `composer test-js` was a command Meta-gen's own
 * conventions described and the repository did not have - and the script it
 * would have run was twelve lines inline in a template, which no test can
 * import. Both halves of that are now fixed.
 */

import { test } from 'node:test';
import assert from 'node:assert/strict';

import { modalSource, showInModal } from '../../src/media/com_metagen/js/generation-modal.js';
