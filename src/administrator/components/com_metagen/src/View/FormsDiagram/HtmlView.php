...
namespace Yepr\Component\Metagen\Administrator\View\FormsDiagram;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$metalanguageId = Factory::getApplication()->getInput()->getInt('metalanguage_id');
		$model->setMetalanguageId($metalanguageId);

		// Get the AST from the model as JSON-string
		$AST = $model->getAST();

		// Get a JSON-diagram of the AST
		// $metalanguage = json_encode($AST, JSON_PRETTY_PRINT); //This gives the M2 JSON; surround it with @startjson and @endjson
		// $umlCreate = [];
		// $umlCreate[] = "@startjson";
		// $umlCreate[] = 	$metalanguage;
		// $umlCreate[] = '@endjson';
