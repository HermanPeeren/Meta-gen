...
/**
 * Model with methods supporting a list of metalanguages.
 */
class MetalanguagesModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__metagen_metalanguages', 'a'));
			...
			$subQuery = $db->getQuery(true)
				...
				->where(
					[
						...
						$db->quoteName('asso1.context') . ' = ' . $db->quote('COM_METAGEN.item'),
					]
				);
