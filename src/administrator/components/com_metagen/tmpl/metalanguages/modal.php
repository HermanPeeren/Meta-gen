...
HTMLHelper::_('script', 'com_metagen/admin-projects-modal.js', array('version' => 'auto', 'relative' => true));
...
<div class="container-popup">
	...
	<form action="<?php echo Route::_('index.php?option=com_metagen&view=projects&layout=modal&tmpl=component&function=' . $function . '&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
			...
			<table class="table table-sm">
				<thead>
					<caption id="captionTable" class="sr-only">
						<?php echo Text::_('COM_METAGEN_PROJECTS_TABLE_CAPTION'); ?>, <?php echo Text::_('JGLOBAL_SORTED_BY'); ?>
					</caption>
					<tr>
