 ...
 *
 * It was twelve lines inline in `tmpl/metalanguages/default.php` with a note
 * asking for exactly this. Moving it out is not tidiness: inline script in a
 * template is script no test can import, and this is the only browser
 * JavaScript Meta-gen owns - everything else on these screens comes from the
 * shared library, where it is tested. `composer test-js` had nothing to run.
 *
